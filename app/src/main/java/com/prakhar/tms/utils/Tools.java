...
import com.prakhar.tms.modals.DeviceInfo;
...
public class Tools {
    ...
    public static void displayImageOriginal(Context ctx, ImageView img, StorageReference url) {
        try {
    ...
    public static DeviceInfo getDeviceInfo(Context context) {
        ...
        deviceInfo.device = com.prakhar.tms.utils.Tools.getDeviceName();
        deviceInfo.os_version = com.prakhar.tms.utils.Tools.getAndroidVersion();
        deviceInfo.app_version = com.prakhar.tms.utils.Tools.getVersionCode(context) + " (" + com.prakhar.tms.utils.Tools.getVersionNamePlain(context) + ")";
        deviceInfo.serial = com.prakhar.tms.utils.Tools.getDeviceID(context);
        return deviceInfo;
    }
